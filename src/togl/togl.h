/* $Id: togl.h,v 1.2 2000/09/24 15:50:39 krmoule Exp $ */
...
/*
 * $Log: togl.h,v $
 * Revision 1.2  2000/09/24 15:50:39  krmoule
 *
 *
 * Bux Fixes:
 * 	* Error in TriStrip.C when outputting strips
 * 	* Error in silhouette.tcl with my version of tcl/tk
 * 	  concerning mouse movement
 *
 * Upgrade:
 * 	* now using Togl 1.6
 * 	* also grabbed more tk header that togl may using
 * 	* the build system now uses autoconf/automake
 *
 * Notes:
 *
 * 	* somebody should probably fill in all the important
 * 	  files like INSTALL, NEWS, AUTHORS, Changelog, etc.
 * 	* i've tested this on my machine but thats not saying
 * 	  much
 *
